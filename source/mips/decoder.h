...
inline uint16_t get_immediate(u32 raw)
{
    return raw & 0xFFFF;
}
inline u8 get_rt(u32 raw)
{
    return (raw >> 16) & 0x1F;
}
inline u8 get_rs(u32 raw)
{
    return (raw >> 21) & 0x1F;
}
...
inline u32 get_target(u32 raw)
{
    return raw & 0x3FFFFFF;
}
inline u8 get_rd(u32 raw)
{
    return (raw >> 11) & 0x1F;
}
inline u8 get_sa(u32 raw)
{
    return (raw >> 6) & 0x1F;
}
...
inline u8 get_ft(u32 raw)
{
    return (raw >> 16) & 0x1F;
}
inline u8 get_fs(u32 raw)
{
    return (raw >> 11) & 0x1F;
}
inline u8 get_fd(u32 raw)
{
    return (raw >> 6) & 0x1F;
}
inline u8 get_fpu_func(u32 raw)
{
    return raw & 0x3F;
}
inline u8 get_base(u32 raw)
{
    return (raw >> 21) & 0x1F;
}
...
inline uint16_t get_offset(u32 raw)
{
    return raw & 0xFFFF;
}

// Helper functions to populate instruction structs using bitwise operations
inline void populate_immediate_instruction(ImmediateInstruction* inst, u32 raw)
{
...
inline void populate_register_instruction(RegisterInstruction* inst, u32 raw)
{
...
inline void populate_register_immediate_instruction(RegisterImmediateInstruction* inst, u32 raw)
{
    inst->immediate = get_immediate(raw);
...
inline void populate_coprocessor_co_func_instruction(CoprocessorCoFuncInstruction* inst, u32 raw)
{
...
inline void populate_coprocessor_op_no_register_instruction(CoprocessorOpNoRegisterInstruction* inst, u32 raw)
{
    inst->immediate = get_immediate(raw);
...
inline void populate_coprocessor_op_register_instruction(CoprocessorOpRegisterInstruction* inst, u32 raw)
{
...
inline void populate_coprocessor_fpu_instruction(CoprocessorFPUInstruction* inst, u32 raw)
{
