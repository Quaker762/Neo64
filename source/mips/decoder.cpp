...
static const FullOp special_op_table[8][8] = {
    {
        FULL_OP_SLL,
        FULL_OP_INVALID,
        FULL_OP_SRL,
...
static const FullOp regimm_op_table[3][8] = {
    {
        FULL_OP_BLTZ,
        FULL_OP_BGEZ,
        FULL_OP_BLTZL,
...
template <FullOp full_op> Instruction mips_decode_jump_type(u32 instruction)
{
    Instruction instruction_data;
...
template <FullOp full_op> Instruction mips_decode_immediate_type(u32 instruction)
{
    Instruction instruction_data;
...
static const CoprocessorType coprocessor_op_table[2][8] = {
    {
...
static const FullOp cop0_op_table[4][7] = {
    {
        FULL_OP_INVALID,
        FULL_OP_TLBR,
        FULL_OP_TLBWI,
